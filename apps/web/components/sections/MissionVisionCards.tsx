    ...
    <section className="py-16 md:py-24 bg-white">
      <div className="max-w-6xl mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          <FadeIn>
            <div className="relative bg-linear-to-br from-petal to-cream rounded-2xl p-8 md:p-10 border border-moss/15 h-full group hover:shadow-lg transition-all duration-500">
              {/* Accent bar */}
              <div className="absolute top-0 left-8 right-8 h-0.5 bg-linear-to-r from-leaf via-fern to-transparent rounded-b" />
          ...
          <FadeIn delay={0.15}>
            <div className="relative bg-linear-to-br from-sand to-petal rounded-2xl p-8 md:p-10 border border-gold/15 h-full group hover:shadow-lg transition-all duration-500">
              {/* Accent bar */}
              <div className="absolute top-0 left-8 right-8 h-0.5 bg-linear-to-r from-gold via-amber to-transparent rounded-b" />
